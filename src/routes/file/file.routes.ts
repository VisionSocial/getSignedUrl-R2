...
fileRouter.get(
  "/signed",
  auth.requestHasAuthorization,
  validator.query(signedSchema),
  async (req: ValidatedRequest<signedRequestSchema>, res: Response) => {
...
fileRouter.delete(
  "/delete",
  auth.requestHasAuthorization,
  validator.query(deleteSchema),
  async (req: ValidatedRequest<deleteRequestSchema>, res: Response) => {
...
fileRouter.get(
  "/copy",
  auth.requestHasAuthorization,
  validator.query(copySchema),
  async (req: ValidatedRequest<copyRequestSchema>, res: Response) => {
...
fileRouter.get(
  "/list",
  auth.requestHasAuthorization,
  validator.query(listSchema),
  async (req: ValidatedRequest<listRequestSchema>, res: Response) => {
